...
``/tmp/bin/minoconda/bioconda-utils bioconductor-skeleton -h`` to view the help.

For example, in the bioconda-recipes directory::

    /tmp/bin/miniconda/bioconda-utils bioconductor-skeleton recipes config.yml DESeq2
